...
- Non-Instagram platforms (LinkedIn, TikTok, X, etc.) → out of scope (no skill for these exists yet)
...
- Paid Instagram ads → use `ad-creative`
- LinkedIn, TikTok, X, YouTube, other platforms — out of scope (no skill for these exists yet)
