...
- Metric is **views** (likes hidden). Median ~567, ceiling ~6,300.
- **Breaking the "New drop" catalog pattern ≈ doubles reach.** Her best post (6,312 views) was a message — *"it's not your body, it's the fit"* — not a product drop.
- **Kill the hashtag wall. Add a comment-driver question** — her comment count is ~0, the single biggest untapped lever.
...
- One **comment-driver question** baked in.
- Caption in her Nepali-English voice; **no hashtag wall**.

Deliver the full script: hook, beat-by-beat, on-screen text, caption, and the `instagram-unskip` self-audit (skip-rate defense, the one shareable line, the comment driver).
